...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT) // 랜덤포트 설정
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
@TestMethodOrder(MethodOrderer.OrderAnnotation.class) // 실행순서
class ProductIntegrationTest {
    @Autowired // 단위테스트에서는 안되었지만 통합테스트에서는 가능!!
